# Generated by Django 3.1.3 on 2020-11-11 20:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.CharField(choices=[('track', 'New Track'), ('dj', 'Live DJ'), ('general', 'General')], default='general', max_length=10)),
                ('description', common.models.TruncatingCharField(max_length=500)),
