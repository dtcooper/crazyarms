    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.CharField(choices=[('track', 'Track'), ('dj', 'Live DJ'), ('general', 'General')], default='general', max_length=10, verbose_name='Type')),
                ('description', common.models.TruncatingCharField(max_length=500, verbose_name='Entry')),
                ('active_source', common.models.TruncatingCharField(max_length=50, verbose_name='Active Source')),
